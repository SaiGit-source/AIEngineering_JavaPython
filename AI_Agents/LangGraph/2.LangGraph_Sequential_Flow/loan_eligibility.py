...
graph.add_edge('calc_eligibility', END) ## last edge is between calc_eligibility and End
...
## Output {'age': 30, 'income': 50000, 'eligible': True, 'max_loan': 250000}
...
with open("AI_Agents\LangGraph\loan_eligibility_graph.png", "wb") as f:
    f.write(png)
