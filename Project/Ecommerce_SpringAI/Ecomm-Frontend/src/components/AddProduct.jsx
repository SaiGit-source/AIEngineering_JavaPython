    ...
    <div className="add-product-page">
      <div className="container py-5">
        <div className="col-md-10">
          <div className="card shadow add-product-card">
            <div className="card-body">
              <h2 className="card-title text-center mb-5 add-product-title">
              ...
              <form className="row g-3 needs-validation" noValidate validated={validated.toString()} onSubmit={submitHandler}>
                ...
                <div className="col-12">
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <button
                      type="button"
                      className={`btn btn-sm btn-outline-primary ai-btn ${!canGenerateDescription ? 'disabled' : ''}`}
