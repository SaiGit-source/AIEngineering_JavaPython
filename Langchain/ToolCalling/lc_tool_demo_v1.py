...
### i change the query
query = "Current time in the country where Messi visited in Dec 2025" ### for this query we need the search tool
...
### Output for Messi visit hallucination
### AIMessage(content='The current date and time in Saudi Arabia, where Messi visited in December 2025, would be December 22, 2025, 7:04 PM (UTC+3).'