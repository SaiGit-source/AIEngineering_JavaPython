...
prompt = "Current time in the country where Messi's debut match for the club took place on July 21, 2023, in a Leagues Cup game against Cruz Azul"
#prompt = "Current time in the country where Messi arrived in Dec 2025"

MCP_FOLDER = r"C:/Users/saito/source/repos/AIEngineering_JavaPython/MCP/Langchain/mcp_server"
load_dotenv()
...
### Output
'''
Lionel Messi's debut match for Inter Miami took place in the United States. The current time in the United States varies across different time zones. Here are the current times in some major U.S. time zones:

- Eastern Standard Time (EST): 2:58 PM
- Central Standard Time (CST): 1:58 PM
- Mountain Standard Time (MST): 12:58 PM
- Pacific Standard Time (PST): 11:58 AM
'''
